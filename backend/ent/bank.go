...
func (e BankEdges) BankPaymentOrErr() ([]*Payment, error) {
	if e.loadedTypes[0] {
...
func (b *Bank) assignValues(values ...interface{}) error {
	...
	if value, ok := values[0].(*sql.NullString); !ok {
		return fmt.Errorf("unexpected type %T for field bank_type", values[0])
	} else if value.Valid {
		b.BankType = value.String
	}
	return nil
}
...
func (b *Bank) String() string {
	...
	builder.WriteString(b.BankType)
	builder.WriteByte(')')
