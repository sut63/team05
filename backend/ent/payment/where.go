...
func Price(v float64) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
...
func PriceEQ(v float64) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPrice), v))
	})
}
...
func PriceNEQ(v float64) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
...
func PriceIn(vs ...float64) predicate.Payment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceNotIn(vs ...float64) predicate.Payment {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceGT(v float64) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
...
func PriceGTE(v float64) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
...
func PriceLT(v float64) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
...
func PriceLTE(v float64) predicate.Payment {
	return predicate.Payment(func(s *sql.Selector) {
