...
func (pu *PositionUpdate) AddMemberIDs(ids ...int) *PositionUpdate {
	pu.mutation.AddMemberIDs(ids...)
	return pu
}

// AddMembers adds the members edges to Member.
func (pu *PositionUpdate) AddMembers(m ...*Member) *PositionUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
...
func (pu *PositionUpdate) AddOfficerIDs(ids ...int) *PositionUpdate {
	pu.mutation.AddOfficerIDs(ids...)
	return pu
}

// AddOfficers adds the officers edges to Officer.
func (pu *PositionUpdate) AddOfficers(o ...*Officer) *PositionUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return pu.AddOfficerIDs(ids...)
}
...
func (pu *PositionUpdate) RemoveMemberIDs(ids ...int) *PositionUpdate {
	pu.mutation.RemoveMemberIDs(ids...)
	return pu
}

// RemoveMembers removes members edges to Member.
func (pu *PositionUpdate) RemoveMembers(m ...*Member) *PositionUpdate {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
...
func (pu *PositionUpdate) RemoveOfficerIDs(ids ...int) *PositionUpdate {
	pu.mutation.RemoveOfficerIDs(ids...)
	return pu
}

// RemoveOfficers removes officers edges to Officer.
func (pu *PositionUpdate) RemoveOfficers(o ...*Officer) *PositionUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return pu.RemoveOfficerIDs(ids...)
}

// Save executes the query and returns the number of rows/vertices matched by this operation.
func (pu *PositionUpdate) Save(ctx context.Context) (int, error) {
	if v, ok := pu.mutation.PositionName(); ok {
...
func (pu *PositionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := pu.mutation.RemovedMembersIDs(); len(nodes) > 0 {
	...
	if nodes := pu.mutation.RemovedOfficersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := pu.mutation.OfficersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   position.OfficersTable,
...
// AddMemberIDs adds the members edge to Member by ids.
func (puo *PositionUpdateOne) AddMemberIDs(ids ...int) *PositionUpdateOne {
	puo.mutation.AddMemberIDs(ids...)
	return puo
}

// AddMembers adds the members edges to Member.
func (puo *PositionUpdateOne) AddMembers(m ...*Member) *PositionUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
...
// AddOfficerIDs adds the officers edge to Officer by ids.
func (puo *PositionUpdateOne) AddOfficerIDs(ids ...int) *PositionUpdateOne {
	puo.mutation.AddOfficerIDs(ids...)
	return puo
}

// AddOfficers adds the officers edges to Officer.
func (puo *PositionUpdateOne) AddOfficers(o ...*Officer) *PositionUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return puo.AddOfficerIDs(ids...)
}
...
// RemoveMemberIDs removes the members edge to Member by ids.
func (puo *PositionUpdateOne) RemoveMemberIDs(ids ...int) *PositionUpdateOne {
	puo.mutation.RemoveMemberIDs(ids...)
	return puo
}

// RemoveMembers removes members edges to Member.
func (puo *PositionUpdateOne) RemoveMembers(m ...*Member) *PositionUpdateOne {
	ids := make([]int, len(m))
	for i := range m {
		ids[i] = m[i].ID
	}
...
// RemoveOfficerIDs removes the officers edge to Officer by ids.
func (puo *PositionUpdateOne) RemoveOfficerIDs(ids ...int) *PositionUpdateOne {
	puo.mutation.RemoveOfficerIDs(ids...)
	return puo
}

// RemoveOfficers removes officers edges to Officer.
func (puo *PositionUpdateOne) RemoveOfficers(o ...*Officer) *PositionUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return puo.RemoveOfficerIDs(ids...)
}

// Save executes the query and returns the updated entity.
func (puo *PositionUpdateOne) Save(ctx context.Context) (*Position, error) {
	if v, ok := puo.mutation.PositionName(); ok {
		if err := position.PositionNameValidator(v); err != nil {
...
func (puo *PositionUpdateOne) sqlSave(ctx context.Context) (po *Position, err error) {
	...
	if nodes := puo.mutation.RemovedMembersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   position.MembersTable,
	...
	if nodes := puo.mutation.RemovedOfficersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   position.OfficersTable,
	...
	if nodes := puo.mutation.OfficersIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   position.OfficersTable,
