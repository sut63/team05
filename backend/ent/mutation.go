...
type AmountpaidMutation struct {
	...
	typ                               string
	id                                *int
	amountpaid_money                  *int
	addamountpaid_money               *int
...
func (m *AmountpaidMutation) SetAmountpaidMoney(i int) {
	m.amountpaid_money = &i
	m.addamountpaid_money = nil
}

// AmountpaidMoney returns the amountpaid_money value in the mutation.
func (m *AmountpaidMutation) AmountpaidMoney() (r int, exists bool) {
...
func (m *AmountpaidMutation) OldAmountpaidMoney(ctx context.Context) (v int, err error) {
...
func (m *AmountpaidMutation) AddAmountpaidMoney(i int) {
	if m.addamountpaid_money != nil {
		*m.addamountpaid_money += i
	} else {
		m.addamountpaid_money = &i
	}
}
...
func (m *AmountpaidMutation) AddedAmountpaidMoney() (r int, exists bool) {
...
type InquiryMutation struct {
	...
	typ                      string
	id                       *int
	_Inquiry_name_messages   *string
	_Inquiry_phone_messages  *string
	_Inquiry_age_messages    *int
	add_Inquiry_age_messages *int
...
func (m *InquiryMutation) SetInquiryNameMessages(s string) {
	m._Inquiry_name_messages = &s
}

// InquiryNameMessages returns the Inquiry_name_messages value in the mutation.
func (m *InquiryMutation) InquiryNameMessages() (r string, exists bool) {
	v := m._Inquiry_name_messages
	if v == nil {
		return
	}
	return *v, true
...
// OldInquiryNameMessages returns the old Inquiry_name_messages value of the Inquiry.
// If the Inquiry object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *InquiryMutation) OldInquiryNameMessages(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldInquiryNameMessages is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldInquiryNameMessages requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldInquiryNameMessages: %w", err)
	}
	return oldValue.InquiryNameMessages, nil
}

// ResetInquiryNameMessages reset all changes of the "Inquiry_name_messages" field.
func (m *InquiryMutation) ResetInquiryNameMessages() {
	m._Inquiry_name_messages = nil
}
...
func (m *InquiryMutation) SetInquiryAgeMessages(i int) {
	m._Inquiry_age_messages = &i
	m.add_Inquiry_age_messages = nil
}

// InquiryAgeMessages returns the Inquiry_age_messages value in the mutation.
func (m *InquiryMutation) InquiryAgeMessages() (r int, exists bool) {
	v := m._Inquiry_age_messages
	if v == nil {
		return
	}
	return *v, true
...
// OldInquiryAgeMessages returns the old Inquiry_age_messages value of the Inquiry.
// If the Inquiry object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *InquiryMutation) OldInquiryAgeMessages(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldInquiryAgeMessages is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldInquiryAgeMessages requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldInquiryAgeMessages: %w", err)
	}
	return oldValue.InquiryAgeMessages, nil
}

// AddInquiryAgeMessages adds i to Inquiry_age_messages.
func (m *InquiryMutation) AddInquiryAgeMessages(i int) {
	if m.add_Inquiry_age_messages != nil {
		*m.add_Inquiry_age_messages += i
	} else {
		m.add_Inquiry_age_messages = &i
	}
}

// AddedInquiryAgeMessages returns the value that was added to the Inquiry_age_messages field in this mutation.
func (m *InquiryMutation) AddedInquiryAgeMessages() (r int, exists bool) {
	v := m.add_Inquiry_age_messages
	if v == nil {
		return
	}
	return *v, true
...
// ResetInquiryAgeMessages reset all changes of the "Inquiry_age_messages" field.
func (m *InquiryMutation) ResetInquiryAgeMessages() {
	m._Inquiry_age_messages = nil
	m.add_Inquiry_age_messages = nil
}
...
func (m *InquiryMutation) Fields() []string {
	...
	if m._Inquiry_name_messages != nil {
		fields = append(fields, inquiry.FieldInquiryNameMessages)
	}
	if m._Inquiry_phone_messages != nil {
		fields = append(fields, inquiry.FieldInquiryPhoneMessages)
	}
	if m._Inquiry_age_messages != nil {
		fields = append(fields, inquiry.FieldInquiryAgeMessages)
	}
...
func (m *InquiryMutation) Field(name string) (ent.Value, bool) {
	switch name {
	case inquiry.FieldInquiryNameMessages:
		return m.InquiryNameMessages()
	case inquiry.FieldInquiryPhoneMessages:
		return m.InquiryPhoneMessages()
	case inquiry.FieldInquiryAgeMessages:
		return m.InquiryAgeMessages()
...
func (m *InquiryMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case inquiry.FieldInquiryNameMessages:
		return m.OldInquiryNameMessages(ctx)
	case inquiry.FieldInquiryPhoneMessages:
		return m.OldInquiryPhoneMessages(ctx)
	case inquiry.FieldInquiryAgeMessages:
		return m.OldInquiryAgeMessages(ctx)
	case inquiry.FieldInquiryMessages:
...
func (m *InquiryMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case inquiry.FieldInquiryAgeMessages:
		return m.AddedInquiryAgeMessages()
	}
	return nil, false
}
...
func (m *InquiryMutation) ResetField(name string) error {
	switch name {
	case inquiry.FieldInquiryNameMessages:
		m.ResetInquiryNameMessages()
		return nil
	case inquiry.FieldInquiryPhoneMessages:
		m.ResetInquiryPhoneMessages()
		return nil
	case inquiry.FieldInquiryAgeMessages:
		m.ResetInquiryAgeMessages()
		return nil
	case inquiry.FieldInquiryMessages:
...
type PaybackMutation struct {
	...
	payback_accountname   *string
	payback_accountiden   *string
	clearedFields         map[string]struct{}
	_Officer              *int
	cleared_Officer       bool
	_Member               *int
...
func (m *PaybackMutation) SetPaybackAccountname(s string) {
	m.payback_accountname = &s
}

// PaybackAccountname returns the payback_accountname value in the mutation.
func (m *PaybackMutation) PaybackAccountname() (r string, exists bool) {
	v := m.payback_accountname
	if v == nil {
		return
	}
	return *v, true
...
// OldPaybackAccountname returns the old payback_accountname value of the Payback.
// If the Payback object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *PaybackMutation) OldPaybackAccountname(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldPaybackAccountname is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldPaybackAccountname requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldPaybackAccountname: %w", err)
	}
	return oldValue.PaybackAccountname, nil
}

// ResetPaybackAccountname reset all changes of the "payback_accountname" field.
func (m *PaybackMutation) ResetPaybackAccountname() {
	m.payback_accountname = nil
}

// SetPaybackAccountiden sets the payback_accountiden field.
func (m *PaybackMutation) SetPaybackAccountiden(s string) {
	m.payback_accountiden = &s
}

// PaybackAccountiden returns the payback_accountiden value in the mutation.
func (m *PaybackMutation) PaybackAccountiden() (r string, exists bool) {
	v := m.payback_accountiden
	if v == nil {
		return
	}
	return *v, true
...
// OldPaybackAccountiden returns the old payback_accountiden value of the Payback.
// If the Payback object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *PaybackMutation) OldPaybackAccountiden(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldPaybackAccountiden is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldPaybackAccountiden requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldPaybackAccountiden: %w", err)
	}
	return oldValue.PaybackAccountiden, nil
}

// ResetPaybackAccountiden reset all changes of the "payback_accountiden" field.
func (m *PaybackMutation) ResetPaybackAccountiden() {
	m.payback_accountiden = nil
}
...
func (m *PaybackMutation) Fields() []string {
	...
	if m.payback_accountname != nil {
		fields = append(fields, payback.FieldPaybackAccountname)
	}
	if m.payback_accountiden != nil {
		fields = append(fields, payback.FieldPaybackAccountiden)
	}
	return fields
}
...
func (m *PaybackMutation) Field(name string) (ent.Value, bool) {
	...
	case payback.FieldPaybackAccountname:
		return m.PaybackAccountname()
	case payback.FieldPaybackAccountiden:
		return m.PaybackAccountiden()
	}
	return nil, false
}
...
func (m *PaybackMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case payback.FieldPaybackAccountname:
		return m.OldPaybackAccountname(ctx)
	case payback.FieldPaybackAccountiden:
		return m.OldPaybackAccountiden(ctx)
	}
...
func (m *PaybackMutation) ResetField(name string) error {
	...
	case payback.FieldPaybackAccountnumber:
		...
		return nil
	case payback.FieldPaybackAccountname:
		m.ResetPaybackAccountname()
		return nil
	case payback.FieldPaybackAccountiden:
		m.ResetPaybackAccountiden()
		return nil
	}
	return fmt.Errorf("unknown Payback field %s", name)
}
...
// OldPhoneNumber returns the old phone_number value of the Payment.
// If the Payment object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
...
func (m *PaymentMutation) SetPrice(f float64) {
	m.price = &f
	m.addprice = nil
}

// Price returns the price value in the mutation.
func (m *PaymentMutation) Price() (r float64, exists bool) {
	v := m.price
	if v == nil {
		return
	}
...
// OldPrice returns the old price value of the Payment.
// If the Payment object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *PaymentMutation) OldPrice(ctx context.Context) (v float64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *PaymentMutation) AddPrice(f float64) {
	if m.addprice != nil {
		*m.addprice += f
	} else {
		m.addprice = &f
...
func (m *PaymentMutation) AddedPrice() (r float64, exists bool) {
	v := m.addprice
	if v == nil {
		return
	}
